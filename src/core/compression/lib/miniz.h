...
MINIZ_EXPORT mz_bool mz_zip_validate_mem_archive(const void *pMem, size_t size,
                                                 mz_uint flags,
                                                 mz_zip_error *pErr);
MINIZ_EXPORT mz_bool mz_zip_validate_file_archive(const wchar_t *pFilename,
                                                  mz_uint flags,
                                                  mz_zip_error *pErr);
...
#ifndef MINIZ_NO_STDIO
MINIZ_EXPORT mz_bool
mz_zip_writer_init_file(mz_zip_archive *pZip, const wchar_t *pFilename,
...
MINIZ_EXPORT mz_bool mz_zip_writer_init_from_reader_v2_noreopen(
    mz_zip_archive *pZip, const wchar_t *pFilename, mz_uint flags);
...
MINIZ_EXPORT mz_bool mz_zip_writer_add_file(
    mz_zip_archive *pZip, const char *pArchive_name, const wchar_t *pSrc_filename,
...
//     const wchar_t *pZip_filename, const char *pArchive_name, const char *pComment,

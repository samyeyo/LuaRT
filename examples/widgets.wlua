...
local combobox = ui.Combobox(win, {"Button", "Label", "Entry", "Picture", "Edit", "Checkbox", "Radiobutton", "Groupbox", "Calendar", "List", "Combobox", "Tree", "Tab"}, label.x + label.width + 8, label.y - 4, 100)
